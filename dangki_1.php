    ...
    <section class="container clearfix">
		<!-- Page Title -->
			<header class="container page_info clearfix">
					...
					<h1 class="regular brown bottom_line">Đăng kí form</h1>
		...
		<!--<div class="">
			<h2 class="red regular">link dang ki cho nha tuyen dung</h2>
			...
			<div class="error_box">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-12 item-abox item-top-box">Ho tên</div>
                        <div class="col-md-9 col-sm-12 item-bbox item-top-box">
		 ...
		 <div class="row">
                    <div class="col-md-3 col-sm-12 item-abox item-top-box">Email</div>
                 ...
                 <div class="row">
                    <div class="col-md-3 col-sm-12 item-abox item-top-box">Quốc gia</div>
                        <div class="col-md-5 col-sm-12 item-bbox item-top-box">
                            <input class="inputtext_box">
                        </div>
                 ...
                 <div class="row">
                    <div class="col-md-3 col-sm-12 item-abox item-top-box">mật khẩu</div>
                        <div class="col-md-5 col-sm-12 item-bbox item-top-box">
                            <input class="inputtext_box">
